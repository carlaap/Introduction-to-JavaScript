...
let firstThing = 'food'
const secondThing = 'pizza'
if (secondThing === 'pizza'){
  firstThing = 'food';
}
...
console.log('task 1 d:', multiply(10, 10));
...
function annoyingSong(number){
      for(let i = number; i > 0; i --){
        return `${i} bottles of soda on the wall, ${number} bottles of soda, take one down pass it around ${i -1} bottles of soda on the wall`;{
